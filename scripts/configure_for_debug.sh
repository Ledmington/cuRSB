...
./configure '--enable-allocator-wrapper'  '--enable-debug' \
       	'FC=gfortran' \
       	'CC=gcc' \
	'CFLAGS=-O0 -fPIC -ggdb -pipe -Wall -Wredundant-decls -Wno-switch -Wdisabled-optimization -Wdeclaration-after-statement   -Wpointer-arith -Wstrict-prototypes ' \
	'FCFLAGS=-O0 -fPIC -ggdb  '	\
	'--enable-librsb-stats' \
